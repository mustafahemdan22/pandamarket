      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        ...
        {user && (
          <button
            ...
            className="mt-4 sm:mt-0 inline-flex items-center px-4 py-2 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition-colors duration-200"
          >
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4 rtl:space-x-reverse">
                  <button
                    ...
                    className="flex items-center space-x-1 rtl:space-x-reverse text-sm text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 transition-colors duration-200"
                  >
