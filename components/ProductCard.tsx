...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  const mainImagePublicId = product.imagePublicId || product.imagePublicIds?.[0] || '';
      ...
      >
        ...
        <div className="relative h-56 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 overflow-hidden">
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)]">
            <motion.button
              ...
              className="w-full bg-green-600 text-white px-5 py-2.5 rounded-lg font-semibold opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center gap-2 hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed shadow-xl"
            >
        ...
        <div className="p-4">
          ...
          <button
            onClick={handleAddToCart}
            disabled={product.stock === 0}
            className="w-full bg-green-600 text-white py-3 rounded-lg font-semibold hover:bg-green-700 active:scale-95 transition-all duration-200 flex items-center justify-center gap-2 disabled:bg-gray-300 dark:disabled:bg-gray-600 disabled:cursor-not-allowed disabled:text-gray-500 dark:disabled:text-gray-400 shadow-md hover:shadow-lg"
          >
            <FiShoppingCart className="w-5 h-5" />
            <span>
              {product.stock === 0
