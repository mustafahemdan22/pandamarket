...
export const sampleProducts: Product[] = [
  ...
  // ============================================
  {
    ...
    price: 5.00,
    image: '/images/placeholder-bakery.webp',
    imagePublicId: '/images/placeholder-bakery.webp',
    imagePublicIds: ['/images/placeholder-bakery.webp'],
    category: 'bakery',
  ...
  // ============================================
  {
    ...
    nameEn: 'Cumin',
    price: 25.00,
    image: '/images/placeholder-spices.webp',
    imagePublicId: '/images/placeholder-spices.webp',
    imagePublicIds: ['/images/placeholder-spices.webp'],
    category: 'spices',
  ...
  // ============================================
  {
    ...
    nameEn: 'Red Tomatoes',
    price: 12.00,
    image: '/images/placeholder-vegetables.webp',
    imagePublicId: '/images/placeholder-vegetables.webp',
    imagePublicIds: ['/images/placeholder-vegetables.webp'],
    category: 'vegetables',
  ...
  // ============================================
  {
    ...
    price: 15.00,
    image: '/images/placeholder-fruits.webp',
    imagePublicId: '/images/placeholder-fruits.webp',
    imagePublicIds: ['/images/placeholder-fruits.webp'],
    category: 'fruits',
...
export const categories = [
  ...
  { id: 'sauces', name: 'الصلصات', nameEn: 'Sauces', slug: 'sauces' },
  { id: 'cleaning', name: 'منتجات التنظيف', nameEn: 'Cleaning', slug: 'cleaning' },
  { id: 'legumes', name: 'البقوليات', nameEn: 'Legumes', slug: 'legumes' },
  { id: 'oils', name: 'الزيوت والسمن', nameEn: 'Oils', slug: 'oils' },
  { id: 'rice', name: 'الأرز والمعكرونة', nameEn: 'Rice & Pasta', slug: 'rice' },
];