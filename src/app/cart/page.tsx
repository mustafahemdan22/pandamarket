...
import { FiShoppingCart, FiPlus, FiMinus, FiTrash2, FiArrowLeft, FiTag, FiPackage } from 'react-icons/fi';
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="w-9 h-9 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            disabled={
                        ...
                        <div className="flex flex-col items-end gap-2">
                          <div className="text-lg font-bold text-gray-900 dark:text-white">
                            {(item.product.price * item.quantity).toFixed(2)} {language === 'ar' ? 'ج.م' : 'EGP'}
                          </div>
                          <button
