...
const ProductDetailPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: language === 'ar' ? 'منتجات طازجة ومضمونة' : 'Fresh and guaranteed products'
    },
    {
      icon: FiRefreshCw,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <nav className="flex items-center space-x-2 rtl:space-x-reverse text-sm text-gray-600 dark:text-gray-400">
            ...
            <span>/</span>
            <Link href="/categories" className="hover:text-green-600 dark:hover:text-green-400">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 rtl:space-x-reverse">
                ...
                <span className="text-sm text-gray-600 dark:text-gray-400">
                  (4.0) • {language === 'ar' ? '12 تقييم' : '12 reviews'}
                </span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4 rtl:space-x-reverse">
                <button
                  ...
                  className="flex-1 bg-green-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-green-700 transition-colors duration-200 flex items-center justify-center space-x-2 rtl:space-x-reverse"
                >
